...
const AddMinFocalLengthRange = ({
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/MinFocalLengthRange", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page || 1,
      });
      toast.success(`AddMinFocal Length Range has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
...
export default AddMinFocalLengthRange;
