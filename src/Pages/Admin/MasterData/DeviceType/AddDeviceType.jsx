...
const AddDeviceType = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    console.log(subCategory, footerCategory);
    try {
      const response = await NewRequest.post("/brand/devicetype", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Device Type has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
