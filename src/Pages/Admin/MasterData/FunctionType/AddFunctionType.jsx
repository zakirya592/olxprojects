...
const AddFunctionType = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/FunctionType", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Function Type has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
