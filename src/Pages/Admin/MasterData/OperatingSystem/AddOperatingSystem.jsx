...
const AddOperatingSystem = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/OperatingSystem", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Operating System has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
