...
const AddConstruction = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/construction", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Construction has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
