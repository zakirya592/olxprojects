...
const AddSensorSize = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/SensorSize", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Sensor Size has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
