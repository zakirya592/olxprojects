...
const Addmake = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
     ...
     formData.append("footerCategory", footerCategory);
     formData.append("status", Page);
    try {
      const response = await NewRequest.post("/brand/make", formData);
      toast.success(`Make has been added successfully.`, {
        position: "top-right",
        autoClose: 2000,
