...
const AddHandmade = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/Handmade", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page || 1,
      });
      toast.success(`Hand Made has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
