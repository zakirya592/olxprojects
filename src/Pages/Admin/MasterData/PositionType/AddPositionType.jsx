...
const AddPositionType = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/PositionType", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page || 1,
      });
      toast.success(`Position Type has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
...
export default AddPositionType;
