...
const AddConstructionState = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/ConstructionState", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Construction State has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
...
export default AddConstructionState;
