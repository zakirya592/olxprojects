...
const AddHardDriveType = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/HardDriveType", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`HardDrive Type has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
...
export default AddHardDriveType;
