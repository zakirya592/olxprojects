...
import AddSex from "./AddSex";
import UpdateSex from "./UpdateSex";
...
const Sex = () => {
  ...
  const handleShowUpdatePopup = (row) => {
    ...
    sessionStorage.setItem("updateSex", JSON.stringify(row));
  };
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (isDeleted) {
            toast.success(`Sex has been deleted successfully!`);
          ...
          <div className="h-auto w-[97%] px-0 pt-4">
            <div className="h-auto w-full p-4 bg-white shadow-xl rounded-md">
              <div className={`flex px-3 flex-row justify-start`}>
                ...
                >
                  <i className="fas fa-plus mr-2"></i>Add Sex
                </button>
              </div>
