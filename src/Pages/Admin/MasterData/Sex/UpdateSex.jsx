...
const UpdateSex = ({ isVisible, setVisibility, refreshBrandData }) => {
  const updateBrandData = JSON.parse(
    sessionStorage.getItem("updateSex")
  );
  ...
  const handleAddCompany = async () => {
    try {
      ...
      toast.success(` Sex has been update successfully".`, {
        position: "top-right",
        autoClose: 2000,
