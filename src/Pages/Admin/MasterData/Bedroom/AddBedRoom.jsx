...
const AddBedRoom = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/bedroom", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`BedRoom has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
