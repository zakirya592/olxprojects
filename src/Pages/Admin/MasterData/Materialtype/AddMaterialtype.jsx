...
const AddMaterialtype = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/Materialtype", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page || 1,
      });
      toast.success(`Material Type has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
