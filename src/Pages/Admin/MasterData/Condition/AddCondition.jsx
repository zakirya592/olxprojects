...
const AddCondition = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    ...
    try {
      const response = await NewRequest.post("/brand/condition", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page,
      });
      toast.success(`Condition has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
