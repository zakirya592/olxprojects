...
const AddMaxAperatureRange = ({ isVisible, setVisibility, refreshBrandData }) => {
  ...
  const handleAddCompany = async () => {
    try {
      const response = await NewRequest.post("/brand/MaxAperatureRange", {
        name: name,
        subCategory: subCategory,
        footerCategory: footerCategory,
        status: Page || 1,
      });
      toast.success(`MaxAperature Range has been added successfully".`, {
        position: "top-right",
        autoClose: 2000,
...
export default AddMaxAperatureRange;
