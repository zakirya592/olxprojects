...
const Hadersilder = () => {
  ...
  return (
    ...
    //             </Swiper>
    //           ) : (
    //             <div className="grid 2xl:grid-cols-6 xl:grid-cols-6 gap-7 lg:grid-cols-5 md:grid-cols-3 grid-cols-1 sm:px-2 px-2 mb-3">
    ...
    //                       <div className="flex text-maincolor mx-2">
    //                         <div className="my-auto ms-2">
    //                           <DescriptionWithToggle description={card.name} />
    //                         </div>
    //                       </div>
    //                       <div className="px-3 flex flex-row mt-3 justify-between gap-2">
    //                         <p className="text-maincolor sm:text-lg text-base">
    //                           {card?.currency || "Rs"}:
    ...
    //                         <img
    //                           src={likeicon}
    //                           className=" text-maincolor cursor-pointer h-7 w-7"
    //                           onClick={() => postcard(card)}
    //                         ></img>
    //                       </div>
    //                     </div>
